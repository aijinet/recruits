# 2020 년 상반기, 개발자 모집
아이지넷은 국내 최초이자 최대의 인공지능 보험 진단 서비스, [보닥 (보험닥터)](https://play.google.com/store/apps/details?id=com.mrp.doctor&hl=ko) 과 [마이리얼플랜](https://www.myrealplan.co.kr) 을 운영하고 있습니다. 이번에 바로 그 아이지넷에서, 소양있는 개발자들을 모십니다.

  - 채용 공고: https://www.wanted.co.kr/company/162
  - 보험닥터: https://play.google.com/store/apps/details?id=com.mrp.doctor&hl=ko
  - 마이리얼플랜: https://www.myrealplan.co.kr

채용은 *서류 전형* - *기술 면접* - *임원 면접* 의 순서로 이루어지며, 아이지넷은 최종 합격한 개발자들에게, 다음과 같은 처우를 약속드립니다.
...
그리고 아이지넷의 개발자들에게, 여타 IT 회사들이 그러하듯, [구글](https://google.com)이나 [깃허브](https://github.com) 및 [스택오버플로](https://stackoverflow.com) 등을 사용하고, 영어 원문으로 된 기술 블로그나 책을 읽는 데 지장이 없을 정도의 독해력을 요합니다. 이 정도면 아마도 평범한 고등학생의 수준이 아닐까 그리 생각합니다.
...
아이지넷은 하드 코딩을 지양하며, 체계적인 설계 및 정제된 타입 정의를 지향합니다. 즉, SW 공학에서 흔히 말하는 표준 개발론이 곧, 아이지넷의 개발팀이 목표하는 지향점입니다. 아이지넷은 이를 실천해 왔고 그것을 통해 목표도 상당수 달성하고 있습니다.
...
> 기술 면접이건 코딩 테스트건, 어디까지나 예를 들어 그렇다는 것입니다.
...
>
> 오늘날 한국의 수많은 IT 회사들은 SW 공학에서 말하는 '표준 개발론' 을 지키고자 무던히도 구호를 외쳐대지만, 이를 실제로 실천하고 있는 회사는 얼마없고, 죄 공염불에 지나지 않습니다.
>
...
아이지넷은 시니어급 개발자에게, 체계적인 설계 능력을 원합니다.
  ...
  - 필요 소양
    - [1.2. 우대 사항](#12-우대-사항)
    - [2.1. Server Developer](#21-server-developer) 에서 말하는 **설계** 능력
...
아이지넷은 시니어급 개발자로써, [1.2. 우대 사항](#12-우대-사항) 을 대체로 충족시거나 또는 장래에 그럴만한 잠재력이 있는 분을 원합니다. 더불어 알고리즘 연구/개발 및 최적화에 소양이 있는 분들은, 연차에 관계없이 무조건 우선 채용하며, 시니어 급으로 우대해드리겠습니다.